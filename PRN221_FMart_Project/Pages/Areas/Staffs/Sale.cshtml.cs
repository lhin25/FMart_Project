...
namespace PRN221_FMart_Project.Pages.Areas.Staffs
{
    ...
    public class SaleModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            ViewData["ProductList"] = JsonConvert.SerializeObject(Products, Formatting.Indented,
            ...
            try
            {
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        string returnUrl = "https://prn221fmartproject20241111115319.azurewebsites.net/Areas/Staffs/Sale";
